    ...
    always @(posedge clk) begin 
        if (reset) begin
            ...
            case (core_state)
                ...
                REQUEST: begin 
                    // REQUEST stage also latches rs/rt, so all ops still pass through it.
                ...
                UPDATE: begin 
                    if (decoded_ret) begin 
                        ...
                        // TODO: Branch divergence. For now assume all active threads converge.
                        // Use lane 0, which is always active for any non-empty block.
