...
module gpu #(
    ...
    parameter THREAD_COUNT_BITS = 8,         // Number of bits used for total thread count / block id bookkeeping
    ...
    // Control
    wire [THREAD_COUNT_BITS-1:0] thread_count;

    // Compute Core State
    reg [NUM_CORES-1:0] core_start;
    reg [NUM_CORES-1:0] core_reset;
    reg [NUM_CORES-1:0] core_done;
    reg [THREAD_COUNT_BITS-1:0] core_block_id [NUM_CORES-1:0];
    ...
    generate
        for (i = 0; i < NUM_CORES; i = i + 1) begin : cores
            ...
            // Combinational pass-through keeps controller/LSU handshake single-stage.
            genvar j;
            ...
            core #(
                ...
                .BLOCK_ID_BITS(THREAD_COUNT_BITS),
                .THREADS_PER_BLOCK(THREADS_PER_BLOCK)
            ) core_instance (
                .clk(clk),
                .reset(core_reset[i]),
